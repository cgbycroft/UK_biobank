...
phenoFileRandom=$basedir/data/GWAS/otherGWAS/PhenotypesForBOLT-v17.txt  # created using subsetPhenotypes.R
...
# List of sample exclusions so that the input matches the imputed data run (v15 or v17)
...
# qsub -q short.qc -P donnelly.prjc runBOLT_v18-LMM.sh
