...
url=paste0("http://hgdownload.cse.ucsc.edu/goldenPath/",build,"/database/cytoBand.txt.gz")

# only download if the new version has been updated
if("cytoBand.txt.gz"%in%list.files()) system(paste0("wget -N ",url)) else system(paste0("wget -S ",url))
