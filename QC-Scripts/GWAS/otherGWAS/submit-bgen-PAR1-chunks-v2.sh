...
impDataX=$basedir/data/imputed/hrc+uk10k_sorted_8bit_rsids_chrPAR1.v4.v1_1 # NOTE: this is a symlink made in subset-sex-chroms.sh
outDataX=$basedir/data/imputed/chrPAR1.v2

# values taken from $outDataX.snpInfo.txt
chunks=`seq 0 500000 2700000`
...
$bgenix -g $impDataX.bgen -incl-range PAR1:$chunk > $outDataX.$i.bgen

# get the list of chrom/snp information
$bgenix -g $outDataX.$i.bgen -incl-range PAR1:$chunk -list > $outDataX.$i.snpInfo.txt
