...
################################
phenotype = "Intra.ocular.pressure..Goldmann.correlated..mean"
################################
...
queryString = "IOP|Intra|ocular|Goldmann"
...
catPheno = catPheno[catPheno$V11%in%c("Intraocular pressure","Glaucoma (high intraocular pressure)"),]
...
Euro = unique(c(grep("European",catPheno$Ancestry),which(catPheno$Ancestry=="")))
