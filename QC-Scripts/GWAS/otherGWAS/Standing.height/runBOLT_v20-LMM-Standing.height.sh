...
#genoBgen=/well/ukbiobank/expt/full_release_issues/uk10k_imputation_annotation/hrc+uk10k_sorted_8bit_rsids_chr$chr.v4.v1_1.bgen  # <== used for v19.
...
# qsub -q short.qc -P donnelly.prjc runBOLT_v20-LMM.sh
