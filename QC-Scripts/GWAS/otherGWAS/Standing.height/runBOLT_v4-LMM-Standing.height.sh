...
phenoFile=$basedir/data/GWAS/otherGWAS/PhenotypesForBOLT-v3.txt  # using White british subset
...
# NOTE: This version uses 20 PCs as covariates - for LMM version as well! And then uses dQC and Cluster.CR as covariates
...
# qsub -q short.qc -P donnelly.prjc runBOLT_v4-LMM.sh
