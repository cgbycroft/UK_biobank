...
genoBgen=/well/ukbiobank/expt/full_release_issues/uk10k_imputation_annotation/hrc+uk10k_sorted_8bit_rsids_chr$chr.v4.v1_1.bgen  # <=== Only chromosome 2 for this!
#genoBgen=/well/ukbiobank/expt/V2_QCed.imputation.bgen_v1.1/data/chr$chr.v2.bgen_v1.1.bgen # <-- made by colin 10/8/2018
...
########
# THIS IS THE ONLY DIFFERENCE BETWEEN v19 and this one
sampleExclude=$basedir/data/GWAS/otherGWAS/SampleExclusionsForBOLT-$vers.txt
...
# qsub -q short.qc -P donnelly.prjc runBOLT_v19b-LMM.sh
