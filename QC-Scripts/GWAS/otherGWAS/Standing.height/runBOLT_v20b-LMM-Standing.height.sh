...
########
# THIS IS THE ONLY DIFFERENCE BETWEEN v20 and this one
sampleExclude=$basedir/data/GWAS/otherGWAS/SampleExclusionsForBOLT-v19b.txt
...
# qsub -q short.qc -P donnelly.prjc runBOLT_v20b-LMM.sh
