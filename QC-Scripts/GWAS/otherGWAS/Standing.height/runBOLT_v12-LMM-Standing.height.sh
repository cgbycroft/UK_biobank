...
#chr=$SGE_TASK_ID
chr=20 # For when running directly on a server
...
#sampleFile=/well/ukbiobank/imputation/final/full/bgen/chr$chr.sample
#genoBgen=/well/ukbiobank/imputation/final/full/bgen/chr$chr.hrc.I4.bgen

sampleFile=/well/ukbiobank/imputation/final/full/bgen/chr20.hrc.I4.new.v1.1.sample
genoBgen=/well/ukbiobank/imputation/final/full/bgen/chr20.hrc.I4.new.v1.1.bgen
