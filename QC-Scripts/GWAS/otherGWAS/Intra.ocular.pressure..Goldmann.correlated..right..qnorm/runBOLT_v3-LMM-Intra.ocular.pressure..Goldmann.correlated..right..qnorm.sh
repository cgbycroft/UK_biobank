...
vers=v3
pheno=Intra.ocular.pressure..Goldmann.correlated..right..qnorm
...
phenoFile=$basedir/data/GWAS/otherGWAS/PhenotypesForBOLT-$vers.txt  # using White british subset
...
# qsub -q short.qc -P donnelly.prjc runBOLT_v3-LMM.sh
