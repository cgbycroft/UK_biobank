#!/bin/bash
#$ -cwd
#$ -N bolt_lmm-quant-Age-Ychrom_v6-sex
#$ -o Logs
#$ -j y
#$ -pe shmem 3
#$ -V
...
vers=v6         # as for v3 but sex chroms
pheno=XYdiff.mean.l2r   # actually X chromosome intensity! THIS IS FOR TESTING VARIANTS ON THE X CHROMOSOME; it assumes that the calls are still good....
...
# qsub -t 23-26 -q short.qb -P donnelly.prjb runBOLT_v6-LMM-sex.sh
