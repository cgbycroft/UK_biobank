#!/bin/bash
#$ -cwd
#$ -N bolt_lmm-quant-Age-Ychrom_v5
#$ -o Logs
#$ -j y
#$ -pe shmem 3
#$ -V
...
vers=v5         # as for v2 but sex chroms
pheno=YXratio.mean.l2r   # THIS IS FOR TESTING VARIANTS ON THE X CHROMOSOME; it assumes that the calls are still good.... probably yes on the non-PAR X...
...
phenoFile=$basedir/data/GWAS/YXintensity/YchromPhenotypesForBOLT-v2.txt
...
# qsub -t 23-26 -q short.qb -P donnelly.prjb runBOLT_v5-LMM.sh
