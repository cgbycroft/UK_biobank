#!/bin/bash
#$ -cwd
#$ -N bolt_lmm-quant-Age-Ychrom_v6
#$ -o Logs
#$ -j y
#$ -pe shmem 5
#$ -V
...
vers=v6 # as for v3 but with a binary phenotype (X0 or XX)
pheno=XYdiff.mean.l2r   # actually X chromosome intensity - Y intensity (then re-logged) see subsetPhenotypes for formular!
