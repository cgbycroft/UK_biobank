...
#$ -N UKBB-pca-UKBio-fastpca-round2-coolibah
...
Input=$basedir/data/PCA/b1__b11-b001__b095-autosome-sampleqc-fastpca-round2-highquality-pruned
Output=$basedir/data/PCA/b1__b11-b001__b095-autosome-sampleqc-fastpca-highquality-round2-coolibah
#######################
...
fastdim: 50
fastiter: $nPCs
" > par.smartpca.round2.coolibah.fast
...
time $smartpca -p par.smartpca.round2.coolibah.fast
...
## run this on short qc. qsub -q coolibah.q -P donnelly.prjc submit-fastpca-round2-coolibah.sh
