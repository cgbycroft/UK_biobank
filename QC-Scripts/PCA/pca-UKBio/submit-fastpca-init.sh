...
nPCs=8 # Just do a quicker run with the first 5 PCs, as we just want to use this to select the SNPs for King
...
Input=$basedir/data/PCA/b1__b11-b001__b095-autosome-sampleqc-fastpca-init-highquality-pruned
Output=$basedir/data/PCA/b1__b11-b001__b095-autosome-sampleqc-fastpca-highquality-init
#######################
...
time $smartpca -p par.smartpca.init.fast
