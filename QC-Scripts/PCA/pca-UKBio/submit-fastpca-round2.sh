...
#$ -N UKBB-pca-UKBio-fastpca-round2
...
Output=$basedir/data/PCA/b1__b11-b001__b095-autosome-sampleqc-fastpca-highquality-round2
#######################
...
time $smartpca -p par.smartpca.round2.fast
...
## run this on short qc. qsub -q short.qc -P donnelly.prjc submit-fastpca-round2.sh
