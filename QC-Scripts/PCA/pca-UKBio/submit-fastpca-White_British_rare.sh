...
Input=$basedir/data/PCA/b1__b11-b001__b095-autosome-sampleqc-fastpca-White_British_rare-highquality-pruned
Output=$basedir/data/PCA/b1__b11-b001__b095-autosome-sampleqc-fastpca-highquality-White_British_rare
#######################
...
fastdim: 50
fastiter: $nPCs
" > par.smartpca.White_British_rare.fast
...
time $smartpca -p par.smartpca.White_British_rare.fast
