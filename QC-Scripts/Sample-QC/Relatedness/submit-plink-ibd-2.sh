...
output=$basedir/data/Relatedness/b1__b11-b001__b095-autosome-sampleqc-filtered.0.003-White_British-2
...
echo $plink --bfile $input --keep $samples --genome full --threads 4 --min $threshold --out $output

time $plink --bfile $input --keep $samples --genome full --threads 4 --min $threshold --out $output
